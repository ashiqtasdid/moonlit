...
const Plan = () => {
  return (
    <div className="max-w-[1310px] mx-auto text-white pb-20">
      {/* Top Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mx-6 md:mx-20">
        <div className="flex flex-col items-start">
          <h1 className="font-semibold pt-7 text-xl">
            Included with <br />
            <span className="text-gray-900">Every Plan</span>
          </h1>
        </div>
        <div className="flex items-center">
          <h2 className="flex font-semibold space-x-2">
            <RiVerifiedBadgeFill className="text-gray-900 mt-0.5" />
        ...
        <div className="flex items-center">
          <h2 className="flex font-semibold space-x-2">
            <RiVerifiedBadgeFill className="text-gray-900 mt-0.5" />
            <span>5</span>
            <SiTrustpilot className="text-gray-900 text-xl mx-1" />
            <span>support</span>
          </h2>
        </div>
        <div className="flex items-center">
