    ...
    <div className="h-screen text-white flex justify-center items-center">
      ...
      >
        ...
        <div className="relative z-10">
          <div className="font-semibold text-xl mb-2">Instant Deployment</div>
          <div className="text-sm text-gray-300">
            Deploy your applications instantly with our streamlined processes,
            enabling you to go live in minutes.
          </div>
        </div>
      </m.div>
    </div>
